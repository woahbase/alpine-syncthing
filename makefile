...
MOUNTFLAGS := # -v $(CURDIR)/config:/home/syncthing/config -v $(CURDIR)/data:/home/syncthing/data # mount in prod
...
PORTFLAGS  := -p 8384:8384 -p 22000:22000 -p 21027:21027/udp
...
test :
	docker run --rm -it $(NAMEFLAGS) $(RUNFLAGS) $(PORTFLAGS) $(MOUNTFLAGS) $(OTHERFLAGS) $(IMAGETAG) sh -ec 'sleep 15; syncthing -version'
