...
# runtime flags
MOUNTFLAGS := \
	# -v $(CURDIR)/data/config:/var/syncthing/config \
	# -v $(CURDIR)/data/data:/var/syncthing/data \
...
OTHERFLAGS := \
	...
	-e PGID=$(PGID) \
	-e PUID=$(PUID) \
	# -e SYNCTHING_HOME=/var/syncthing \
	# -e SYNCTHING_DATA=/var/syncthing/data \
...
SRC_ARCH_MAP := \
	...
	'loong64') echo -n 'linux-loong64';; \
	'ppc64le') echo -n 'linux-ppc64le';; \
	'riscv64') echo -n 'linux-riscv64';; \
	's390x'  ) echo -n 'linux-s390x'  ;; \
